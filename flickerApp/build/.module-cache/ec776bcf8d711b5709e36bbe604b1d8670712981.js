...
var SearchBox = React.createClass({displayName: "SearchBox",
	...
	enLargeThumb: function(img){
		console.log("INSIDE ENLARGE THUMB, YIPEEEEEEE"); 
          					...
          					this.state.photos.map(function(item,i){
          						return (
          							React.createElement("a", {href: item}, 
          								React.createElement("img", {src: item, height: "100", width: "250", onmouseover: this.enLargeThumb})
          							)
          						);
          					},this)
          				)
