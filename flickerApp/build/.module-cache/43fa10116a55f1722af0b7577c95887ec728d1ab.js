...
var SearchBox = React.createClass({displayName: "SearchBox",
	...
	doSearch:function(e){
		...
		$.get(`${base}&method=flickr.photos.search&text=${searchQuery}&sort={this.state.selectedValue}&per_page=12&page=1`, function(data){
	...
	render:function(){
		...
		return(
			React.createElement("div", {className: ""}, 
				...
				React.createElement("select", {value: this.state.selectedValue, onChange: this.changeSelect}, 
