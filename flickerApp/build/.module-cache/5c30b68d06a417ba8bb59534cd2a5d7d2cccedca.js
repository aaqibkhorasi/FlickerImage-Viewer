...
var SearchBox = React.createClass({displayName: "SearchBox",
	...
	doSearch:function(e){
		...
		$.get(`${base}&method=flickr.photos.search&text=${searchQuery}&sort=date-posted-desc&per_page=12&page=1`, function(data){
		...
		return(
			React.createElement("div", {className: ""}, 
				...
				React.createElement("select", null, 
					React.createElement("option", {value: "asc"}, "sort by date(Ascending)"), 
					React.createElement("option", {value: "desc"}, "sort by date(Descending)")
				), 
